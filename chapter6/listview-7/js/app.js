  ...
  var Tag = (function() {
    ...
    */
    ...
    Tag.prototype.toListItem = function() {
      ...
      return "<li class='" + obsoleteClass + "'><a href='http://developer.mozilla.org/en/HTML/Element/" + this.name + "'><img class='ui-li-icon' src='images/" + iconFile + "'><h1>" + this + "</h1><p> " + this.explain + "</p>" + obsolete + newTag +"</a></li>";
    }
