(function() {
  ...
  $(function(){
    ...
    for (var i=0, len=tags.length; i<len; i++) {
      ...
      $('#tags').append("<li class='" + obsoleteClass + "'><a href='http://developer.mozilla.org/en/HTML/Element/" + tag.name + "'><img src='images/" + iconFile + "' class='ui-li-icon'><h1>" + tag + "</h1><p> " + tag.explain + "</p>" + obsolete + newTag +"</a></li>");
    }
