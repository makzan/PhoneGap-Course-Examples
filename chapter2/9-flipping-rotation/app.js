...
(function(){
  ...
  }).call(scope); // end of ticker module
  ...
  (function() {
    ...
    var TwentyFiveTimer = (function() {
      ...
      TwentyFiveTimer.prototype.reset = function() {
        scope.tf.ticker.removeListener(this); // remove self instance from the ticker list.
      ...
      TwentyFiveTimer.prototype.start = function() {
        scope.tf.ticker.addListener(this); // add self instance to the ticker list, so we will get tick invoked.
      }

      TwentyFiveTimer.prototype.stop = function() {
        scope.tf.ticker.removeListener(this);
      }
    ...
    scope.tf.TwentyFiveTimer = TwentyFiveTimer;
  ...
  (function() {
    ...
    $(function() {
      ...
      // regitsering Cube Rotation transition
      $.mobile.transitionHandlers.fliprotation = $.mobile.transitionHandlers.simultaneous;
      ...
      var timer = new scope.tf.TwentyFiveTimer($('#timer'));
      timer.start();
  ...
  }).call(scope); // end of the app module
